...
public class Schema<T> {
    ...
    */
    ...
    public String getType() {
        var bindTypes = Boolean.parseBoolean(System.getProperty(BIND_TYPE_AND_TYPES, "false"));
    ...
    public int hashCode() {
        return Objects.hash(
                title, multipleOf, maximum, exclusiveMaximum, exclusiveMaximumValue, minimum,
                ...
                types, allOf, anyOf, oneOf, _const, contentEncoding, contentMediaType, contentSchema, propertyNames,
                unevaluatedProperties, maxContains, minContains, additionalItems, unevaluatedItems, _if, _else, then,
                dependentRequired, dependentSchemas, $comment, examples, prefixItems, items
        );
    }
    ...
    public String toString() {
        ...
        var typeStr = specVersion == SpecVersion.V30 ? type : types;
        ...
        var exclusiveMaximumStr = specVersion == SpecVersion.V30 ? exclusiveMaximum : exclusiveMaximumValue;
        sb.append("    exclusiveMaximum: ").append(toIndentedString(exclusiveMaximumStr)).append("\n");
        sb.append("    minimum: ").append(toIndentedString(minimum)).append("\n");
        var exclusiveMinimumStr = specVersion == SpecVersion.V30 ? exclusiveMinimum : exclusiveMinimumValue;
    ...
    public enum SchemaResolution {
        // Jackson: @JsonProperty("default")
        DEFAULT("default"),
        // Jackson: @JsonProperty("inline")
        INLINE("inline"),
        // Jackson: @JsonProperty("all-of")
        ALL_OF("all-of"),
        // Jackson: @JsonProperty("all-of-ref")
